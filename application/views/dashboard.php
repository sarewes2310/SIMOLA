...
<head>
    ...
    <script src="<?php echo base_url()?>assets/js/variabel_utama.js" type="text/javascript" charset="utf-8" async defer></script>
</head>
<body>
    <div class="wrapper">
        <!-- Sidebar  -->
	...
	<!--<script type="text/javascript" src="assets/js/menuSiswa.js"></script>-->
