...
<head>
    ...
    <link href="http://simola.herokuapp.com/assets/css/signin.css" rel="stylesheet">
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm col-ml col-lg">
        <div class="isi">
            <img src="http://simola.herokuapp.com/assets/logo/SIM_1.png" style="width: calc(100% / 2);">
        </div>
        <div class="isi">
